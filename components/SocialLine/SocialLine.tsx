...
const SocialsLine = () => {
  ...
  return (
    <ul
      className={cn(
        'fixed bottom-0 hidden left-8 showSocial:block after:bg-black dark:after:bg-white',
        styles['socials-line'],
      )}
      ref={ref}
    >
          ...
          <SocialLink
            ...
            icon={
              <svg
                ...
                className="duration-[.1s] fill-current group-hover:transform group-hover:-translate-y-1 group-hover:text-accent group-hover:duration-[400] w-5 text-dark-black dark:text-white"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
