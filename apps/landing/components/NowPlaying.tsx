...
function AnimatedBars() {
  ...
  return (
    <div className="w-auto flex items-end overflow-hidden">
      <span id="bar1" className="w-1 mr-[3px] h-2 bg-flat-green opacity-75" />
      <span id="bar2" className="w-1 mr-[3px] h-1 bg-flat-green" />
      <span id="bar3" className="w-1 h-3 bg-flat-green opacity-80" />
    </div>
  );
}
